# SMArt Email Documentation — Claude Code Project

This repository contains the SMArt Email utility documentation site built with Docusaurus. SMArt Email is an OpCon connector that periodically checks an email mailbox and submits OpCon events based on subject, body, or attachment matches.
